...
package com.ruishan.ruixiao.hcnet;
...
public interface HCNetSDK extends StdCallLibrary {
    ...
    //加载HCNetSDK.dll
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(".\\src\\main\\resources\\HCNetSDK\\HCNetSDK",
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
//网络(NET_DVR_NETCFG_V30结构)
    ...
    public static final int NET_DVR_GET_CARD_RIGHT_WEEK_PLAN = 2126;    //获取卡权限周计划参数
    public static final int NET_DVR_SET_CARD_RIGHT_WEEK_PLAN = 2127;    //设置卡权限周计划参数
    public static final int NET_DVR_GET_CARD_RIGHT_WEEK_PLAN_V50 = 2322;  //获取卡权限周计划参数V50
    public static final int NET_DVR_SET_CARD_RIGHT_WEEK_PLAN_V50 = 2323;  //设置卡权限周计划参数V50
